...
def populate_BDD(assets_array):
    ...
    for i in range(0,len(asset_array)):
        ...
        historical_data = historical_price['historical'].apply(pd.Series)[['date', 'close', 'volume']]
        ...
        column_order = ["ticker", "exchange", "date", "close", "volume", "ema", "dema", "williams", "rsi", "adx", "standardDeviation"]
